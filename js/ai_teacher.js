        ...
        sendSymptom.addEventListener('click', async () => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    // 处理响应格式
                    let aiResponse = '收到您的咨询，我会尽力为您提供专业的解答。';
    ...
    function showLoadingState() {
        ...
        loadingDiv.innerHTML = `
            <div style="text-align: center; padding: 20px;">
                ...
                <p style="color: #666; margin-top: 10px;">百科全书正在分析中...</p>
            </div>
        `;
            ...
            aiResult.innerHTML = `
                <div class="welcome-message">
                    <div style="text-align: center; margin-bottom: 30px;">
                        <h3 style="color: var(--accent); margin-bottom: 15px;">👨‍⚕️ 欢迎使用百科全书</h3>
                        <p>我可以为您提供专业的知识问答</p>
                    </div>
                    <div class="abcde">
                        <div class="abcd">
